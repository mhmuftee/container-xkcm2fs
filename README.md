...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xkcm2fs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xkcm2fs.containers.anotherwebservice.com/
...
```
git clone git@github.com:mhmuftee/container-xkcm2fs.git
cd container-xkcm2fs
```
...
```
docker attach container-xkcm2fs
```
